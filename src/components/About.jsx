...
const About = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-screen lg:min-h-[200vh] w-full"
    >
      <div className="relative h-auto lg:sticky lg:top-0 lg:h-screen w-full bg-black overflow-hidden flex flex-col justify-center py-20 lg:py-0">
        ...
        >
          ...
          <div className="lg:hidden mb-12 text-center">
            <h2 className="text-4xl font-black text-[#e8e3da] tracking-tighter">
              ABOUT ME
            </h2>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="relative group w-full max-w-[420px] aspect-square md:w-96 md:h-96 lg:w-[500px] lg:h-[550px]"
              >
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: false, amount: 0.3 }}
              className="flex flex-col justify-center space-y-6 lg:space-y-8 lg:pt-16"
            >
              {/* Header */}
              <div>
                <motion.h2
                  variants={itemVariants}
                  className="text-[#e8e3da] text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.9] mb-4 lg:mb-6"
                >
                  CRAFTING
                  <br />
                ...
                <motion.div
                  variants={itemVariants}
                  className="h-0.5 w-32 bg-white/20"
                />
              </div>
              ...
              <motion.div
                variants={itemVariants}
                className="space-y-4 lg:space-y-6 text-base lg:text-xl font-light text-neutral-300 leading-relaxed max-w-xl"
              >
                <p>
                  I am a creative developer who bridges the gap between{" "}
                  <strong className="text-white font-bold">design</strong> and{" "}
                  <strong className="text-white font-bold">technology</strong>.
                  My passion lies in building immersive web experiences that are
                  not just functional, but memorable.
                </p>
                <p className="text-neutral-500 text-base lg:text-lg">
                  With a deep understanding of modern frameworks and a keen eye
                  for aesthetics, I transform complex problems into elegant,
                  scalable solutions.
                </p>
              </motion.div>
              ...
              <motion.div
                variants={itemVariants}
                className="grid grid-cols-2 lg:grid-cols-4 gap-4 border-t border-white/10 pt-10"
              >
                {stats.map((stat, i) => (
                  <div key={i} className="space-y-1">
                    <h4 className="text-3xl lg:text-4xl font-black text-white">
                      {stat.value}
                    </h4>
