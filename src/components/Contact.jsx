  ...
  const contactInfo = [
    {
      ...
      // link: "mailto:support@domain.com",
    },
    {
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center w-full">
            ...
            <div className="order-1 space-y-6 lg:space-y-8">
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    {info.link ? (
                      <a 
                        href={info.link} 
                        className="text-neutral-300 text-base lg:text-lg font-medium hover:text-white transition-all"
                      >
                        {info.value}
                      </a>
                    ) : (
              ...
              <motion.div variants={leftVariants} className="pt-4">
                <p className="text-neutral-500 text-xs font-semibold uppercase tracking-wider mb-4">Follow Me</p>
            ...
            <motion.div variants={rightVariants} className="order-2">
              <div className="bg-neutral-900/80 backdrop-blur-sm border border-neutral-700 rounded-2xl p-6 md:p-8 lg:p-10 shadow-2xl">
                <h3 className="text-white text-2xl md:text-3xl font-bold mb-8">Send a Message</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {/* Message */}
                  <div>
                    <label className="block text-neutral-400 text-sm font-medium mb-2">Message</label>
                    <textarea
                      rows="5"
                  ...
                  {submitStatus === "success" && (
                    <motion.div
                      ...
                      className="flex items-center justify-center gap-2 p-4 bg-neutral-800 border border-neutral-700 rounded-xl"
                    >
